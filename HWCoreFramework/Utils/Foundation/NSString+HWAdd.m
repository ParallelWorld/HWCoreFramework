...
- (NSString *)hw_md5String {
    return [[self dataUsingEncoding:NSUTF8StringEncoding] hw_md5String];
}

- (NSString *)hw_sha1String {
    return [[self dataUsingEncoding:NSUTF8StringEncoding] hw_sha1String];
}

- (NSString *)hw_base64EncodedString {
    return [[self dataUsingEncoding:NSUTF8StringEncoding] hw_base64EncodedString];
}

+ (NSString *)hw_stringWithBase64EncodedString:(NSString *)base64EncodedString {
    NSData *data = [NSData hw_dataWithBase64EncodedString:base64EncodedString];
...
- (CGFloat)hw_widthForFont:(UIFont *)font {
    CGSize size = [self hw_sizeForFont:font size:CGSizeMake(HUGE, HUGE) mode:NSLineBreakByWordWrapping];
    return size.width;
}

- (CGFloat)hw_heightForFont:(UIFont *)font width:(CGFloat)width {
    CGSize size = [self hw_sizeForFont:font size:CGSizeMake(width, HUGE) mode:NSLineBreakByWordWrapping];
    return size.height;
}
